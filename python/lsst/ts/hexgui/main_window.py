...
class MainWindow(QMainWindow):
    ...
    def __init__(
        ...
        tabs = [
            ...
            TabDriveStatus("Drive Status", self.model),
        ...
        self.setWindowTitle(f"{hexapod_type.name} Control")
    ...
    def _set_log(
        ...
        if is_output_log_to_file:
            logging.basicConfig(
                filename=self._get_log_file_name(hexapod_type),
    ...
    def _get_log_file_name(
        self,
        hexapod_type: MTHexapod.SalIndex,
        default_log_dir: str = "/rubin/hexapod/log",
    ) -> pathlib.Path:
        ...
        default_log_dir : `str`, optional
            Default log directory. (the default is "/rubin/hexapod/log")
