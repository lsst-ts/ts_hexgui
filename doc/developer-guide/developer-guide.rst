...
.. _lsst.ts.hexgui-modules_hexgui_signals:
...
* **SignalApplicationStatus** sends the current application status.
* **SignalPosition** sends the current position of hexapod.
* **SignalPower** sends the current current and voltage.
* **SignalControl** sends the commands of the struts.
